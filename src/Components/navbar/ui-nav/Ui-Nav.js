...
class ui-nav extends React.Component {
  state = { toggle: true }
  ...
  render() {
    ...
    return (
      <Spring
        from={{ color: 'black' }}
        to={{
          color: toggle ? 'black' : 'orange',
          start: toggle ? 'blue' : 'white',
...
ReactDOM.render(<Ui-Nav />, document.getElementById('root'))

export default Ui-Nav;