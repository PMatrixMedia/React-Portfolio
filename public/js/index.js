...
TweenMax.set($textInverse, {x: -(text2w + windowWidth)});
TweenMax.to($textRegular1, 100, {x: '-100%'});
TweenMax.to($textRegular2, 100, {x: '-100%'});
TweenMax.to($textInverse, 10, {x: text2w - windowWidth});
